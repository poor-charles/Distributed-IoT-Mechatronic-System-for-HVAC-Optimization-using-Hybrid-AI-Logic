...
const char* mqtt_client_id = "ESP32_InsideSensor1";

const char* temp_topic    = "/room/temp1";
const char* humid_topic   = "/room/humid1";
const char* voltage_topic = "/esp/voltage1";
const char* power_topic   = "/esp/power1";
const char* status_topic  = "/esp/status1";
